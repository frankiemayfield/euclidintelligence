      ...
      <div className="p-6 lg:p-8">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          <TabsList className="mb-6">
            ...
            <TabsTrigger value="scope-structure">Scope Structuring</TabsTrigger>
                          ...
                          {isExpanded && (
                            <div className="px-4 pb-4 ml-7 space-y-2 text-xs">
                              <div className="bg-muted/30 rounded-xl p-3 space-y-2">
                                ...
                                <div><span className="text-muted-foreground">Euclid Analysis:</span> <span className="text-foreground ml-1">{item.atlasNote}</span></div>
