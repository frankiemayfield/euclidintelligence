  ...
  return (
    <section id="pricing" className="py-24 bg-background">
      <div className="container mx-auto px-4 lg:px-8 text-center">
        ...
        <p className="text-muted-foreground max-w-lg mx-auto mb-8">Upload your project files and generate a structured estimate, a trade-level market comparison, and proposal in minutes.
