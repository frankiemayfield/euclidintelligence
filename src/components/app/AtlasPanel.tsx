...
const initialResponses: Record<string, string> = {
  ...
  "/app/proposal-comparison": "Your proposal is benchmarked against 20,000+ similar projects. Market Fit Score is 78. I can explain variances and pricing position.",
    ...
    <div className="w-80 border-l border-border bg-card flex flex-col shrink-0 h-full">
      ...
      <div className="px-4 py-3 border-b border-border flex items-center justify-between shrink-0">
        <div className="flex items-center gap-2">
          ...
          <div>
            <p className="text-xs font-semibold text-foreground">Atlas</p>
