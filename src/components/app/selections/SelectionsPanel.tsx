    ...
    <div className="border-t border-border/40 bg-card/25 p-4 text-[11px]">
      ...
      {s.overdueDays ? (
        ...
        <EuclidImpact className="mt-3" domain="Cost" tone="warning"
          ...
          action={change ? { label: "Open the change", to: `${base}/projects/${s.projectId}/financials/change-orders` } : undefined} />
      ) : null}
      ...
      <div className="mt-3 flex flex-wrap gap-2 font-semibold text-primary">
        ...
        {change && <Link to={`${base}/projects/${s.projectId}/financials/change-orders`} className="rounded-full bg-primary/10 px-3 py-1">View Change {change.id}</Link>}
