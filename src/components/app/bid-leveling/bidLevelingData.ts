...
export const bids: Record<string, SubBid[]> = {
  ...
  Framing: [
    {
      sub: "TrueFrame Carpentry", rawTotal: 131850, addBacks: 0, leveledTotal: 131850,
      notes: "Fregolle v2 — complete framing package", recommended: true, selected: true,
      recommendedReason: "Best-fit complete scope after clarification and revision review",
      status: "Selected", packageCoverage: 98, missingScopeCount: 0,
      scopeNotes: ["Full framing package", "Includes sheathing, blocking, and structural hardware"],
      ...
      clarifications: [],
      adjustments: [],
      uploadedFrom: "TrueFrame_Fregolle_Framing_v2.pdf",
    },
    {
      sub: "Queen City Framing", rawTotal: 136900, addBacks: 1800, leveledTotal: 138700,
      notes: "Complete package excluding engineered lumber handling", status: "Ready to Compare",
      packageCoverage: 94, missingScopeCount: 1,
      scopeNotes: ["Includes sheathing and blocking", "Excludes engineered lumber handling"],
      inclusions: ["Framing labor", "Sheathing", "Blocking", "Hardware"],
      exclusions: [
        { item: "Engineered lumber handling", disposition: "add-to-estimate" },
      ],
      clarifications: [
        { question: "Confirm engineered lumber unloading and staging", resolved: false },
      ],
      adjustments: [
        { description: "Add engineered lumber handling", amount: 1800, reason: "Required logistics excluded from base bid" },
      ],
      uploadedFrom: "QueenCity_Fregolle_Framing.pdf",
    },
    {
      sub: "Precision Structural Carpentry", rawTotal: 127600, addBacks: 8900, leveledTotal: 136500,
      notes: "Lower base with blocking and hardware exclusions", status: "Needs Clarification",
      packageCoverage: 86, missingScopeCount: 2,
      scopeNotes: ["Framing labor and sheathing included", "Blocking and structural hardware excluded"],
      inclusions: ["Framing labor", "Wall sheathing", "Roof sheathing"],
      exclusions: [{ item: "Blocking", disposition: "add-to-estimate" }, { item: "Structural hardware", disposition: "add-to-estimate" }],
      clarifications: [{ question: "Confirm engineered lumber installation is included", resolved: false }],
      adjustments: [{ description: "Add blocking and hardware", amount: 8900, reason: "Required Fregolle scope excluded from base bid" }],
      uploadedFrom: "PrecisionStructural_Fregolle_Framing.pdf",
    },
  ],
};
